...
class SparseRoIHead(CascadeRoIHead):
    ...
    def __init__(self,
        ...
        self.log_folder = "calibration/query_inst/detections/val/"
    ...
    def simple_test(self,
        ...
        boxes = proposal_list[0] / proposal_list[0].new_tensor(scale_factor)
        ...
        with open(filename, "a") as f:
            x = np.concatenate((cls_score[0].cpu().numpy(), boxes.cpu().numpy()), axis=1)
            np.save(filename, x)
