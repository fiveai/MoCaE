...
class BBoxTestMixin:
    ...
    def simple_test_bboxes_with_features(self,
                           x,
                           img_metas,
                           proposals,
                           rcnn_test_cfg,
        ...
        bbox_pred = bbox_results['bbox_pred']
        if final_feats:
            features = bbox_results['final_feats']
        else:
        ...
        raw_predictions = []
        for i in range(len(proposals)):
            raw_prediction = self.bbox_head.get_bboxes(
                rois[i],
                cls_score[i],
                bbox_pred[i],
                img_shapes[i],
        ...
        return raw_predictions, features

    def simple_test_bboxes_with_raw_detections(self,
                           x,
                           img_metas,
                           proposals,
                           rcnn_test_cfg,
        ...
        for i in range(len(proposals)):
            scores, bboxes = self.bbox_head.get_bboxes(
                rois[i],
                cls_score[i],
                bbox_pred[i],
                img_shapes[i],
