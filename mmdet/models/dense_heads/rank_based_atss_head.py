...
from mmdet.core import (anchor_inside_flags, build_assigner, build_sampler,
                        ...
                        vectorize_labels, bbox_overlaps)
...
class RankBasedATSSHead(AnchorHead):
    ...
    def __init__(self,
        ...
        super(RankBasedATSSHead, self).__init__(
            num_classes,
            in_channels,
    ...
    def loss(self,
        ...
        if len(pos_inds) > 0:
            pos_decode_bbox_targets = torch.cat(all_bbox_targets)[pos_inds]
            ...
            flat_labels[flat_labels==1] = torch.clamp(IoU_targets + EPS, max=1)
