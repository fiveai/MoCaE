...
class ATSSHeadRaw(AnchorHead):
    ...
    def __init__(self,
        ...
        super(ATSSHeadRaw, self).__init__(
            num_classes,
            in_channels,
    ...
    def simple_test(self, feats, img_metas, rescale=False):
        ...
        Returns:
            list[tuple[Tensor, Tensor]]: Each item in result_list is 2-tuple.
                ...
                with shape (n, ).
        """
        return self.simple_test_bboxes_raw(feats, img_metas, rescale=rescale)
    ...
    def _bbox_post_process(self,
        ...
        return mlvl_nms_scores, mlvl_bboxes
