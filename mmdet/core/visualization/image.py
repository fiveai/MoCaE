...
def imshow_det_bboxes_moe(img,
    ...
    if bboxes is not None:
        ...
        bbox_palette[0]=(255/255, 165/255, 0/255)
        bbox_palette[1]=(255/255, 0/255, 0/255)
        bbox_palette[2]=(150/255, 75/255, 0/255)
        thickness = 3
        #colors = [bbox_palette[int(idx)] for idx in det_idx]
        colors = [bbox_palette[0] for idx in range(num_bboxes)]
        #colors = [bbox_palette[1] for idx in range(num_bboxes)]
        #colors = [bbox_palette[2] for idx in range(num_bboxes)]
